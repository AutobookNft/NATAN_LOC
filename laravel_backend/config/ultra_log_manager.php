...
return [
    'log_channel' => env('ULTRA_LOG_MANAGER_LOG_CHANNEL', 'upload'),
    'log_level' => env('ULTRA_LOG_MANAGER_LOG_LEVEL', 'debug'),
    'log_backtrace_depth' => env('ULTRA_LOG_MANAGER_BACKTRACE_DEPTH', 3),
    'backtrace_limit' => env('ULTRA_LOG_MANAGER_BACKTRACE_LIMIT', 7),
    'supported_languages' => explode(',', env('ULTRA_LOG_MANAGER_SUPPORTED_LANGUAGES', 'it,en')),
